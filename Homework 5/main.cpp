...
int main()
{
    ...
    for (int i = 1; i<=10; i++) {
        ...
        outstream <<"Student Name: " <<"Student " + to_string(i) <<endl;
        outstream <<"Number of Visits: " <<scount <<endl;
        outstream <<"Topic A: " <<tcount[0] <<" times" <<endl;
        outstream <<"Topic B: " <<tcount[1] <<" times" <<endl;
        outstream <<"Topic C: " <<tcount[2] <<" times" <<endl;
        outstream <<"Topic D: " <<tcount[3] <<" times" <<endl <<endl <<endl;
    }
    outstream.close();
    return 0;
}
